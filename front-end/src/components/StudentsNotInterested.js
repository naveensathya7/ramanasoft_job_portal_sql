...
const StudentsNotAttended = () => {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get('http://localhost:5000/applications/not-interested'); // Adjust the URL as needed
...
export default StudentsNotAttended;
